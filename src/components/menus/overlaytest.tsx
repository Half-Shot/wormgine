...
export const OverlayTest: FunctionalComponent = () => {
    ...
    return <main>
        <button onClick={() => setWeaponMenuOpen(true)}>
            Open Weapon Menu
        </button>
        {weaponMenuOpen && <WeaponSelector weapons={[WeaponBazooka, WeaponGrenade, WeaponShotgun, WeaponGrenade, WeaponShotgun, WeaponGrenade, WeaponShotgun]} onWeaponPicked={() => setWeaponMenuOpen(false)} />}
    </main>;
}