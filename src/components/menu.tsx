...
function mainMenu(onStartNewGame: (level: string) => void, setCurrentMenu: (menu: GameMenu) => void, clientReady?: boolean) {
    return <main className="menu">
        ...
        <ul className="levelPicker">
            ...
            <li>
                <button onClick={() => setCurrentMenu(GameMenu.AccountMenu)}>Manage Account</button>
            </li>
            <li>
                <button disabled={!clientReady} onClick={() => setCurrentMenu(GameMenu.TeamEditor)}>Edit Teams</button>
            </li>
            <li>
